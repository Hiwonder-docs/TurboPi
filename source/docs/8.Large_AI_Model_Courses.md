...
<img src="../_static/media/chapter_8/1.3/media/image10.png" />
...
① Click the terminal icon <img src="../_static/media/chapter_8/section_4.3/media/image2.png" /> in the system desktop to open a command-line window.
...
(2) On the Raspberry Pi desktop, double-click the **"Terminator"** icon <img src="../_static/media/chapter_8/section_4.3/media/image4.png" /> to open the terminal, and enter the ROS2 development environment.
