...
(2) Click the terminal icon <img src="../_static/media\chapter_4\section_1\media\image3.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
* By default, the system launches the threshold adjustment tool automatically on startup. You can simply click the icon <img  src="../_static/media\chapter_4\section_1\media\image22.png"  /> to open it.
...
(1) Double-click the desktop icon <img src="../_static/media\chapter_4\section_1\media\image22.png"  /> and click Execute in the pop-up dialog.
...
<img   class="common_img"  src="../_static/media\chapter_4\section_1\media\image26.png"  />
...
<img   class="common_img"  src="../_static/media\chapter_4\section_1\media\image40.png"  />
...
<img   class="common_img"  src="../_static/media\chapter_4\section_1\media\image41.png"  />
...
<img   class="common_img"  src="../_static/media\chapter_4\section_1\media\image42.png"  />

(11) Next to save the changes. Press the Esc key, then type the command “:wq” and press Enter to save and exit.

<img   class="common_img"  src="../_static/media\chapter_4\section_1\media\image43.png"  />
...
(2) Click the terminal icon <img  src="../_static/media/chapter_4/section_2/media/image3.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
* By default, the system launches the threshold adjustment tool automatically on startup. You can simply click the icon <img src="../_static/media/chapter_4/section_2/media/image31.png"  /> to open it.
...
(1) Double-click the desktop icon <img  src="../_static/media/chapter_4/section_2/media/image31.png"  /> and click Execute in the pop-up dialog.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image32.png"  />

(2) Once the interface opens, click Connect to connect the camera.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image33.png"  />

(2) After a successful connection, select red from the color options in the lower-right corner of the interface.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image34.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image35.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image37.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image38.png"  />

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image39.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image40.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image41.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image42.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image44.png"  />

(4) Use the dropdown menu in the color selector to choose purple.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image45.png"  />

(5) Point the camera at a purple object. Adjust the L, A, and B sliders until the target area turns white on the left side of the screen, while other areas turn black.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image46.png"  />

(6) Click Save to store the new threshold settings.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image47.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image50.png"  />

(10) Then follow steps 1 to 2 of section 5.2 Changing the Default Recognized Color again to open the program file, press the "i" key to enter edit mode, and locate the section of code as shown in the figure below.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image51.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image52.png"  />

(12) Locate the line in the code as shown below.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image53.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image54.png"  />

(14) Locate the line in the code as shown below.

<img   class="common_img"  src="../_static/media/chapter_4/section_2/media/image55.png"  />
...
(2) Click the terminal icon <img  src="../_static/media/chapter_4/section_3/media/image3.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
* By default, the system launches the threshold adjustment tool automatically on startup. You can simply click the icon <img   src="../_static/media/chapter_4/section_3/media/image20.png"  /> to open it.
...
(1) Double-click the desktop icon <img   src="../_static/media/chapter_4/section_3/media/image20.png"  /> and click Execute in the pop-up dialog.

<img   class="common_img"  src="../_static/media\chapter_4\section_1\media\image23.png"  />

(2) Once the interface opens, click Connect.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image22.png"  />

(3) After a successful connection, select red from the color options in the lower-right corner of the interface.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image23.png"  />

(4) If no image appears in the preview window, the camera may not be connected correctly. Please check the camera cable.

On the right side of the interface, you will see the live camera feed. On the left side is the color area to be sampled. Point the camera at a red color sample, then adjust the six sliders below the image until the red area on the left turns completely white, and all other areas become black. Then, click Save to save the adjusted threshold settings.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image24.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image25.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image26.png"  />

(4) Use the dropdown menu in the color selector to choose purple.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image27.png"  />

(5) Point the camera at a purple object. Adjust the L, A, and B sliders until the target area turns white on the left side of the screen, while other areas turn black.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image28.png"  />

(6) Click Save to store the new threshold settings.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image29.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image32.png"  />

(10) Type :q and press Enter to exit this file.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image33.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image36.png"  />

(14) Press i to enter edit mode.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image37.png"   />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image38.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image39.png"  />

(17) Next to save the changes. Press the Esc key, then type the command “:wq” and press Enter to save and exit.

<img   class="common_img"  src="../_static/media/chapter_4/section_3/media/image40.png"  />
...
(2) Click the terminal icon <img src="../_static/media/chapter_4/section_4/media/image3.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_5/media/image1.png"  />

(2) Click the terminal icon <img   src="../_static/media/chapter_4/section_5/media/image2.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
(2) Click the terminal icon <img  src="../_static/media/chapter_4/section_6/media/image3.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
(2) Click the terminal icon <img  src="../_static/media/chapter_4/section_7/media/image4.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_7/media/image24.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_7/media/image25.png"  />

(5) Modify the line Threshold = 30.0, changing 30.0 to 20.0, as shown in the image below.

<img   class="common_img"  src="../_static/media/chapter_4/section_7/media/image26.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_7/media/image27.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_7/media/image28.png"  />

(5) Modify the line speed = 0.4, changing 0.4 to 0.2, as shown in the image below.

<img   class="common_img"  src="../_static/media/chapter_4/section_7/media/image29.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image2.png"  />

(2) Click the terminal icon <img src="../_static/media/chapter_4/section_8/media/image3.png"  /> in the upper-left corner of the system desktop to open a command-line window.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image9.png"  /><img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image10.png"  />
...
(4) Convert images to binary images which contain only 0 and 1 values, making them simpler and easier to process.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image20.png"  />
...
(5) To reduce noise and make the image smoother, morphological operations are applied — specifically, opening and closing.

`mask`: erosion followed by dilation.  

`mask`: dilation followed by erosion. The function `cv2.morphologyEx()` is used for morphological operations.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image21.png"  />

Parameter 1: `frame_mask` — the input image.

Parameter 2: `cv2.MORPH_OPEN` — the type of morphological operation to perform. Common types include:  

`cv2.MORPH_ERODE` — erosion, `cv2.MORPH_DILATE` — dilation, `cv2.MORPH_OPEN` — opening (erosion followed by dilation), `cv2.MORPH_CLOSE` — closing (dilation followed by erosion).

Parameter 3: `np.ones((3, 3))` — the kernel.

Parameter 4: `np.uint8` — the number of iterations.

(6) After the above processing, contour detection is used to identify the target object. The findContours() function from the cv2 library is used.
...
(7) A conditional statement is used to determine which color in the image has the largest area.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image25.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image26.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image27.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image28.png"  />
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image29.png"  />
...
The robot follows the black line forward. When it detects red, the buzzer beeps once, the expansion board’s red light turns on, and the robot stops moving. When it detects green, the robot continues to move forward.
...
<img   class="common_img"  src="../_static/media/chapter_4/section_8/media/image30.png"  />