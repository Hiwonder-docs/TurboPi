...
<img src="../_static/media/6.mecanum_wheel_control/1.1/image2.png"  />
...
<img class="common_img" src="../_static/media/6.mecanum_wheel_control/1.1/image3.png"   />
...
According to characteristic of mecanum wheel, only when four wheels rotates forward, car can go forward. The analysis of force is as pictured. <img src="../_static/media/6.mecanum_wheel_control/2.1/image2.png"  />
...
<img class="align-center"  src="../_static/media/6.mecanum_wheel_control/2.1/image6.png"  />
...
<img class="align-center"  src="../_static/media/6.mecanum_wheel_control/2.1/gif1.gif"  />
...
(4) Input command ": set number" and press Enter to display the line number.
...
<img class="align-center"  src="../_static/media/6.mecanum_wheel_control/2.1/image13.png"  />
...
(4) Input command "sudo python3 Car_Turn_Demo.py" and press Enter to start the game.
...
<img class="align-center"  src="../_static/media/6.mecanum_wheel_control/3.1/gif1.gif"  />
...
<img class="align-center"  src="../_static/media/6.mecanum_wheel_control/3.1/image12.png"  />
...
### 4.3 Function Extension

The default speed of going forward is 50. You can change the speed in the program. For example, 90.

<img class="align-center"  src="../_static/media/6.mecanum_wheel_control/4.1/gif1.gif"  />
...
(2) Input command **"cd TurboPi/MecanumControl/"** and press Enter to enter the directory where game programs are stored.
...
<img class="align-center" src="../_static/media/6.mecanum_wheel_control/4.1/image12.png"  />
...
<img class="align-center" src="../_static/media/6.mecanum_wheel_control/5.1/gif.gif"  />
...
<img class="align-center" src="../_static/media/6.mecanum_wheel_control/5.1/image13.png"  />
...
<img class="align-center" src="../_static/media/6.mecanum_wheel_control/6.1/gif.gif"  />
...
<img class="align-center" src="../_static/media/6.mecanum_wheel_control/6.1/image12.png"  />
...
(6) After modification, repeat operation in "[6.2 Operation Steps]()" to check robot performance.
