...
(2) TurboPi Advanced Packing List
...
spacer*6<br>M3 nut*12<br>M2 nut*4<br>Nylon rivet*3)</td>
     ...
     <tr>
      ...
      <td>1</td>
      <td><img src="../_static/media/chapter_1/1.1/image29.png" width="220px"></td>
    </tr>
    <tr>
      <td>30</td>
      <td> Type C cable</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/1.1/image30.png" width="250px"></td>
    </tr>
  </tbody>
</table>
...
For a clearer, dynamic walkthrough of the assembly process, [check out the YouTube video tutorial here](https://www.youtube.com/playlist?list=PLFbzd0m6AcmLzo53o2Tsa20BS350rWGMj).
...
(1) Click the desktop icon <img src="../_static/media/chapter_1/5.1/image5.png"/> to open the terminal, then switch to the corresponding directory.

```bash
cd software/Servo_upper_computer/
```

(2) Launch the servo debugging software.
...
(3) Click the "**Load Offsets**" button, then select the .yaml file located at: **/home/ubuntu/software/Servo_upper_computer** to load the servo deviations.
...
(4) Drag the slider for Servo 2 to adjust the TurboPi’s U-shaped bracket so that it is parallel with the base bracket.

:::{Note}

 **The adjustable range is from 1372 to 1627. If the U-shaped bracket can be aligned within this range, it is considered a minor deviation.** If the required adjustment exceeds this range, it is considered a major deviation, and you should follow the section [1.9.4 Calibrate Large Deviation](#anchor_1_9_4) of this document.

:::

<img class="common_img" src="../_static/media/chapter_1/5.1/image9.png" />

(5) After adjustment, click "**Save Offsets**", select the .yaml file under the directory of **/home/ubuntu/software/Servo_upper_computer** to save the updated deviation values to TurboPi.

<img class="common_img" src="../_static/media/chapter_1/5.1/image10.png" />

<img class="common_img" src="../_static/media/chapter_1/5.1/image14.png" />

(6) In the pop-up confirmation dialog, select "**Yes**" to complete the saving process.

<img class="common_img" src="../_static/media/chapter_1/5.1/image15.png" />

<img class="common_img" src="../_static/media/chapter_1/5.1/image16.png" />
