...
<table class="docutils-nobg" border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center">1</td>
      <td style="text-align: center"><img src="../_static/media/1.getting_ready/1.1/image7.0.png" width="250px"></td>
    </tr>
    <tr>
      <td style="text-align: center">8</td>
      <td style="text-align: center">Raspberry Pi expansion board</td>
      <td style="text-align: center">1</td>
      <td style="text-align: center"><img src="../_static/media/1.getting_ready/1.1/image7.png" width="180px"></td>
    </tr>
    <tr>
    ...
    <td style="text-align: center">10</td>
      ...
      <td style="text-align: center">1</td>
      <td style="text-align: center"><img src="../_static/media/1.getting_ready/1.1/image7.1.png" width="50px"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align: center">Mecanum wheels <br> (Wheel A *2; Wheel B *2)</td>
      <td style="text-align: center">4</td>
...
<img class="common_img" src="../_static/media/1.getting_ready/2.1/image23.jpg"   />
