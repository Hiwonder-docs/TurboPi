...
For detailed feedback behavior, please refer to section [1.3 Program Outcome](#anchor_1_3).
...
(1) Power on the robot and use VNC Viewer to connect to the remote desktop.<img src="../_static/media/8.ai_vision_project/1.1/image2.png"  />
...
- If color recognition is inaccurate, refer to the section"[2.3 Adjusting Color Thresholds](#anchor_1_4_1)"in this document to adjust the color threshold settings.
:::
...
**1.4.1 Adjusting Color Thresholds**
...
(1) Double-click<img src="../_static/media/8.ai_vision_project/1.1/image7.png"  /> and in the popup interface, click **"Execute."**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image9.png"  />
...
**1.4.2 Changing the Default Recognized Color**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image13.png"  />

<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image14.png"  />

(4) Press the **"i"** key on the keyboard to enter edit mode.

<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image15.png"   />

(5) Replace "red" (highlighted in red in the image) with "green," as shown in the image below:

<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image16.png"   />

<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image17.png"   />

(6) To save your changes, press the **"Esc"** key, then type **":wq"** (note the colon before "wq") and press Enter to save and exit.

<img class="align-center" src="../_static/media/8.ai_vision_project/1.1/image18.png"   />
...
The source code of this program is saved in: **[/home/pi/TurboPi/function_demo/individual_colors.py]()**
...
:::{Note}
before color recognition, please adjust the deviation of pan tilt according to the file in"**["Getting Ready\8.Adjust Pan-Tilt](https://docs.hiwonder.com/projects/TurboPi/en/latest/docs/1.getting_ready.html#id21)**".
:::
...
Please scroll down to get more information about robot's reaction in"[2.3 Program Outcome](#anchor_2_3)"。
...
- If TurboPi cannot recognize color accurately, please refer to"[2.4.1 Adjust Color Threshold](#anchor_2_4_1)"
:::
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image9.png"  />
...
**2.4.2 Change Default Recognition Color**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image13.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image14.png"  />

(5) Replace "red" with "green" in "detect_color == 'red'" as pictured:

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image15.png"  />
...
(7) Input command "python3 ColorDetect.py" and press Enter to start color recognition.

```commandline
sudo python3 ColorDetect.py
```

**2.4.3 Add New Recognition Color**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image17.png"  />

(4) Select the color you just added. For example, purple.

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image18.png"  />
...
(10) According to step 1-2 of the "[4.2 Change Default Recognition Color](#anchor_2_4_2)" and press Enter to open program file. Next, press "I" key to start editing. Find the following codes.

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image24.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image25.png"  />

(12) Jump to the codes as pictured.

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image26.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image27.png"  />

(14) Find the following codes.

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image28.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image29.png"  />

(16) Locate the following codes.

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image30.png"  />

(17) Input the content as the figure shown. Determine whether the purple color is recognized.

<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image31.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/2.1/image32.png"  />

(19)  Restart this game according to the instructions in "[2.2 Start and Close the Game](#anchor_2_2)". Hold a purple item in front of the camera. When recognizing purple, TurboPi will shake. If you want to make it nod, you can make purple default recognition color according to "[2.4.2 Change Default Recognition Color](#anchor_2_4_2)".
...
The source code of this program is stored in **[/home/pi/TurboPi/Functions/ColorDetect.py]()**
...
- If color recognition is inaccurate, refer to the section "[3.4.1 Adjusting Color Threshold](#anchor_3_4_1)" in this document to adjust the color threshold settings.
:::
...
**3.4.1 Adjusting Color Threshold**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/3.1/image9.png"  />
...
**3.4.2 Adding New Recognizable Colors**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/3.1/image12.png"  />

(4) Next, click the dropdown button in the color selection box and choose "purple."

<img class="align-center" src="../_static/media/8.ai_vision_project/3.1/image13.png"  />
...
The source code for this program is located at：**[/home/pi/TurboPi/function_demo/Target_location_identification.py]()**
...
- Please operate in well-lit environment, since light can affect recognition result.
- Remove objects of the same color or similar color to the target object, otherwise TurboPi will misrecognize.
- If TurboPi cannot recognize color accurately, please refer to"[4.4.1 Adjust Color Threshold](#anchor_4_4_1)".
:::
...
<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image9.png"  />
...
(2) Input command "sudo vim ColorTracking.py" and press Enter to open program file.
...
<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image13.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image14.png"  />

(5)  Replace "red" with "blue" in "target_color = ('red',)" as pictured:

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image15.png"  />

:::{Note}
you only can replace red with the color listed in the drop-down menu. If you want to change it to other colors, you can add new recognition color according to"[4.3 Add New recognition Color](#anchor_4_4_3)"
:::
...
**4.4.3 Add New Recognition Color**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image17.png"  />

(4)  Select the color you just added. For example, purple.

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image18.png"  />
...
(10) According to step 1-2 in "[4.4.2 Change Tracked Color](#anchor_4_4_2)", press Enter to open program file. Next, press "I" key to start editing. Find the following codes.

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image24.png"  />

(11)  Input `purple` and`'purple': (128, 0, 128)`. (128, 0, 128) represents RGB value of purple. The order of the RGB order is needed to be switched to BGR. Therefore, the value of purple here is still (128, 0, 12). You can go to [RGB Color Extractor](http://tools.jb51.net/static/colorpicker/) to check search the value of RGB.

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image25.png"  />

(12)  Jump to the codes as pictured.

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image26.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image27.png"  />

(14) Find the following codes

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image28.png"  />

(15) Change **"red"** to **"purple"**.

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image29.png"  />
...
(17)  Restart this game according to the instructions in "[4.2 Start and Close the Game](#anchor_4_2)". Hold a purple item in front of the camera, and the TurboPi will move with it.
...
<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image31.png"  />

(2) Locate the main function of the color tracking program.

<img class="align-center" src="../_static/media/8.ai_vision_project/4.1/image32.png"  />
...
(5) Simply re-enter the command to start color tracking, following the steps in "[4.2 Start and Close the Game](#anchor_4_2)"
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image10.png"   />

(3) After camera returned image shows up. Select "black" in drop-down menu.

<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image11.png"   />

(4) If there is no camera returned image, camera is not connected. Please check whether the camera cable is connected to Raspberry Pi board.

Image on right is real-time image transmitted by camera, and image on left displays the collected color. Focus camera on black line. Then drag six sliders below to make the black line turn white and other area turn black. After that, click **"Save"** button.

<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image12.png"   />

<p id="anchor_5_4_2"></p>

**5.4.2 Change Tracked Color**
...
(3) Input ": set number" and press Enter to display the line number.
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image15.png"   />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image16.png"   />

(6)  Replace "black" with "red" of "target_color = ('black',)".

<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image17.png"   />
...
**5.4.3 Add New Recognition Color**

Besides two built-in colors, you can add other colors, such as purple.

(1) Double click <img src="../_static/media/8.ai_vision_project/5.1/image19.png"  /> open this software. Then click "execute".
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image20.png"  />

(4) Select the color you just added. For example, purple.

<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image21.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image26.png"   />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image28.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image30.png"  />

(15)  Change **"black"** to **"purple".**

<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image31.png"  />

(16) After modification, press **"Esc",** input **":wq"** and then press Enter to save and close the file.

<img class="align-center" src="../_static/media/8.ai_vision_project/5.1/image18.png"   />

(17)  Set the default recognition color as purple according to "[5.4.2 Change Tracked Color](#anchor_5_4_2)". Then restart this game according to the instructions in "[5.2 Start and Close the Game](#anchor_5_2)". TurboPi can go forward following the purple line.

(18)  You can refer to the above steps if you need to add other colors as the recognizable color.

### 5.5 Program Analysis

The source code of this program is stored in **[/home/pi/TurboPi/Functions/VisualPatrol.py]()**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/6.1/gif.gif"  />

### 6.4 Program Analysis

The source code of this program is stored in **[/home/pi/TurboPi/Functions/QuickMark.py]()**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/image7.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/gif.gif"  />

### 7.4  Function Extension

**7.4.1 Change the Distance Threshold**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/image11.png"  />

(6) Replace "30.0" with "20.0" of "Threshold = 30.0".

<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/image12.png"  />

(7) After modification, press **"Esc"** key, input **":wq"** and then press Enter to save and close the file.

<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/image13.png"   />

(8) Restart this game according to "[7.2 Start and Close the Game](#anchor_7_2)". TurboPi will turn left when the distance from the obstacle id smaller or equal to 20cm.
...
<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/image14.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/7.1/image15.png"  />
...
(7) Restart the game according to "[7.2 Start and Close the Game](#anchor_7_2)". TurboPi will move at the speed of 20.

### 7.5 Program Analysis

The source code of this program is stored in **[/home/pi/TurboPi/Functions/Avoidance.py]()**

**7.5.1  Import Function Library**
...
<img class="align-center" src="../_static/media/8.ai_vision_project/8.1/gif.gif"  />

### 8.4 Program Analysis

The source code of this program is stored in  **[/home/pi/TurboPi/Functions/FaceTracking.py]()**
...
The implementation of autonomous driving is divided into two parts, including color recognition and line following. To get more information about color recognition, please refer to "[2. Color Recognition](#anchor_2)". 
...
Then, TurboPi will recognize color as driving. If it detects red light, the car will stop going forward. If it recognizes green light, it will continue to go forward. (For the principle of color recognition, please refer to the "[2. Color Recognition](#anchor_2)")

### 9.2 Preparation

Install 4-channel line follower on TurboPi according to "[Getting Ready\4.Assembly](https://docs.hiwonder.com/projects/TurboPi/en/latest/docs/1.getting_ready.html#assembly)". Then connect line follower to I2C interface on Raspberry Pi expansion board with 4PIN wire. Next, use black electrical tape to make a line map as pictured. Users need to purchase the traffic lights separately, or use green and red balls as traffic light.
...
The source code of this program is stored in **[/home/pi/TurboPi/Functions/LineFollower.py]()**
...
To get more information of robot actions, please refer to "[10.3 Program Outcome](#anchor_10_3)".
...
<table class="docutils" style="margin:0 auto" border="1">
    ...
    <tbody>
        <tr>
            <td>Gesture "1"</td>
            <td><img src="../_static/media/8.ai_vision_project/10.1/image8.png" alt="手势1图片" /></td>
            <td>Go forward </td>
        </tr>
        <tr>
            <td>Gesture"2"</td>
            <td><img src="../_static/media/8.ai_vision_project/10.1/image9.png" alt="手势2图片" /></td>
            <td>Go backward</td>
        </tr>
        <tr>
            <td>Gesture"3"</td>
            <td><img src="../_static/media/8.ai_vision_project/10.1/image10.png" alt="手势3图片" /></td>
            <td>Move right</td>
        </tr>
        <tr>
            <td>Gesture"4"</td>
            <td><img src="../_static/media/8.ai_vision_project/10.1/image11.png" alt="手势4图片" /></td>
            <td>Move left</td>
        </tr>
        <tr>
            <td>Gesture"5"</td>
            <td><img src="../_static/media/8.ai_vision_project/10.1/image12.png" alt="手势5图片" /></td>
            <td>Rotate clockwise once in place</td>
        </tr>
        <tr>
            <td>Gesture"6"</td>
            <td><img src="../_static/media/8.ai_vision_project/10.1/image13.png" alt="手势6图片" /></td>
            <td>Rotate counterclockwise once in place</td>
        </tr>
    </tbody>
</table>

<img src="../_static/media/8.ai_vision_project/10.1/1.gif" class="align-center"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/10.1/image15.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/10.1/image16.png"  />

(5) Change "45" as "90" of "car.set_velocity(45,90,0)" as pictured:

<img class="align-center" src="../_static/media/8.ai_vision_project/10.1/image17.png"  />
...
<img class="align-center" src="../_static/media/8.ai_vision_project/10.1/image20.png"  />
...
The source code of this program is stored in **[/home/pi/TurboPi/Functions/GestureRecognition.py]()**
