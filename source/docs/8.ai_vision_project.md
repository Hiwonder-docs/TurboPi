...
(10) According to step 1-2 in "4.2 Change Tracked Color", press Enter to open program file. Next, press "I" key to start editing. Find the following codes.
...
(10) According to step 1-2 of the "[5.4.2 Change Tracked Color]()" and press Enter to open program file. Next, press "I" key to start editing. 
...
(17)  Set the default recognition color as purple according to "[5.4.2 Change Tracked Color]()". Then restart this game according to the instructions in "[5.2 Operation Steps]()". TurboPi can go forward following the purple line.
...
<img src="../_static/media/8.ai_vision_project/6.1/gif.gif"  />
...
<img src="../_static/media/8.ai_vision_project/7.1/gif.gif"  />
...
(8) Restart this game according to "[7.2 Operation Steps]()". TurboPi will turn left when the distance from the obstacle id smaller or equal to 20cm.
...
(7) Restart the game according to "[7.2 Operation Steps]()". TurboPi will move at the speed of 20.
...
<img src="../_static/media/8.ai_vision_project/8.1/gif.gif"  />
...
The implementation of autonomous driving is divided into two parts, including color recognition and line following. To get more information about color recognition, please refer to "[AI Vision Projects\2 Color Recognition]()". 
...
Then, TurboPi will recognize color as driving. If it detects red light, the car will stop going forward. If it recognizes green light, it will continue to go forward. (For the principle of color recognition, please refer to the "[AI Vision Projects\2 Color Recognition")



### 9.2 Preparation

Install 4-channel line follower on TurboPi according to "[Getting Ready\4.Assembly]()". Then connect line follower to I2C interface on Raspberry Pi expansion board with 4PIN wire. Next, use black electrical tape to make a line map as pictured. Users need to purchase the traffic lights separately, or use green and red balls as traffic light.
...
To get more information of robot actions, please refer to "[10.3. Program Outcome]()".
...
<img src="../_static/media/8.ai_vision_project/10.1/1.gif"  />
