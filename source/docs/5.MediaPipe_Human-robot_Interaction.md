...
2)  Click the terminal icon <img src="../_static/media/chapter_5\section_1/media/image4.png" style="width:40px"  class="inline-icon" /> in the system desktop to open a ROS2 command-line window.
...
2)  Click the terminal icon <img src="../_static/media/chapter_5\section_1/media/image4.png"  /> in the system desktop to open a ROS2 command-line window.
